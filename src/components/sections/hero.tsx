  ...
  return (
    <SectionWrapper id="hero" className={cn("relative w-full h-screen")}>
      <div className="grid md:grid-cols-2">
          ...
          {!isLoading && (
            <div className="flex flex-col">
              ...
              <div className="mt-8 flex flex-col gap-3 w-fit">
                <Link
                  href={
                    // ⚠️ TODO: Ensure this is your latest resume link
                    "https://drive.google.com/file/d/1tbhEBCUz0zkOZEAGmHLqlcp7n0Qv2zUt/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
        ...
        {/* The 3D scene (Keyboard) renders in this empty column via a separate component */}
